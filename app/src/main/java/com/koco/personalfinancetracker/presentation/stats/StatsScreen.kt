...
import com.koco.personalfinancetracker.presentation.home.TransactionList
import com.koco.personalfinancetracker.utils.Utils

@Composable
fun StatsScreen(navController: NavController, viewModel: StatsViewModel = hiltViewModel(), homeViewModel: HomeViewModel = hiltViewModel()) {
    ...
    Scaffold(topBar = {
        ...
        Column(modifier = Modifier.padding(it)) {
            ...
            ExpensePieChart(transactions = state.value)
        }
    }
}
